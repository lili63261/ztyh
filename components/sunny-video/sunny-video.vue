<template>
	<view class="sunny-video" :style="{width:elVideoWidth.strNum,height:elVideoHeight.strNum}">
		<video :style="{width:elVideoWidth.strNum,height:elVideoHeight.strNum}" id="sunnyVideo" ref="sunnyVideo" play-strategy="1" :title="title" :src="src" :show-center-play-btn="false" :controls="controls" :enable-play-gesture="enablePlayGesture" :loop="loop" :muted="muted" :autoplay="autoplay" @timeupdate="timeupdate" enable-play-gesture :show-mute-btn="showMuteBtn" @play="play" @pause="pause" @ended="ended" @error="playError" @fullscreenchange="fullscreenchange">
